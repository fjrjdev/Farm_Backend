# Generated by Django 2.2 on 2023-01-26 21:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('municipality', models.CharField(default='not defined', max_length=255, verbose_name='Municipality')),
                ('state', models.CharField(default='not defined', max_length=255, verbose_name='State')),
